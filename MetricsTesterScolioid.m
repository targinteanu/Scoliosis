...
%% build and plot a random scoliotic spine-like curve 
...
numvertebrae = 24;
coarse = linspace(0, tmax, numvertebrae)'; fine = (0:.1:tmax)';
...
ax(2) = subplot(2,1,2); 
plot(vertebrae, concavities); grid on;
xlabel('vertebra'); ylabel('|| d^2r / dt^2 ||'); 
title('Lewiner second derivative');
