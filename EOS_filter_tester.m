...
%        'FilterOrder',5, 'DesignMethod','butter');
    filt_iir = designfilt('lowpassiir', 'PassbandFrequency',.004, 'SampleRate',fs, ...
        'StopbandFrequency',.005, 'DesignMethod','butter', ...
        'StopbandAttenuation',5, 'PassbandRipple',1);
    filt_chb = designfilt('lowpassiir', 'PassbandFrequency',.0033, 'SampleRate',fs, ...
